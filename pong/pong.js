...
Pong = {
  ...
  Defaults: {
    ...
    ballSpeed:    2.75,     // should be able to cross court horizontally in 4 seconds, at starting speed ...
  ...
  Levels: [
    {aiReaction: 0.2, aiError:  30}, // 0:  ai is losing by 8
    {aiReaction: 0.25, aiError:  40}, // 1:  ai is losing by 7
    {aiReaction: 0.3, aiError:  50}, // 2:  ai is losing by 6
    {aiReaction: 0.35, aiError:  60}, // 3:  ai is losing by 5
    {aiReaction: 0.4, aiError:  70}, // 4:  ai is losing by 4
    {aiReaction: 0.45, aiError:  80}, // 5:  ai is losing by 3
    {aiReaction: 0.5, aiError: 90}, // 6:  ai is losing by 2
    {aiReaction: 0.55, aiError: 100}, // 7:  ai is losing by 1
    {aiReaction: 0.6, aiError: 110}, // 8:  tie
    {aiReaction: 0.65, aiError: 120}, // 9:  ai is winning by 1
    {aiReaction: 0.7, aiError: 130}, // 10: ai is winning by 2
    {aiReaction: 0.75, aiError: 140}, // 11: ai is winning by 3
    {aiReaction: 0.8, aiError: 150}, // 12: ai is winning by 4
    {aiReaction: 0.85, aiError: 160}, // 13: ai is winning by 5
    {aiReaction: 0.9, aiError: 170}, // 14: ai is winning by 6
    {aiReaction: 0.95, aiError: 180}, // 15: ai is winning by 7
    {aiReaction: 1.0, aiError: 190}  // 16: ai is winning by 8
  ],
  ...
  Paddle: {
    ...
    moveUp:         function() { this.up   = 2; },
    moveDown:       function() { this.down = 2; },
